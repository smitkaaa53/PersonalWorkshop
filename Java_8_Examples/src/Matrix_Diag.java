class Matrix_Diag {
	...
	static void diagonalOrder(int matrix[][]) {
		...
		for (int line = 1; line <= (ROW + COL - 1); line++) {
			...
			System.out.println("line:"+line + " (COL - start_col):"+(COL - start_col)+" ROW:"+ROW);
			
			System.out.println("line:"+line + " start_col:"+start_col+" count:"+count);
	...
	/*static void diagonalZigZagOrder(int matrix[][]) {
